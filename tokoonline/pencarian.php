    ...
    <body>
        ...
        <div class="container">
            ...
            <?php if(empty ($semuadata)): ?>
                <div class="alert alert-danger">Data pencarian <strong><?php echo $keyword ?></strong> tidak ditemukan</div>
            <?php endif ?>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="thumbnail">
                        <img src="fotoproduk/<?php echo $value['foto_produk'] ?>" alt="" class="img-responsive">
                        <div class="caption">
