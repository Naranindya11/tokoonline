...
//jk tdk ada login maka akan dilarikan ke login.php
        ...
        <div class="container">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <!--menampilkan produk yg sdng di perulangkan berdasarkan id_produk-->
                    <?php
            ...
            <form method="post">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <input type="text" readonly value="<?php echo $_SESSION["pelanggan"]
                            ['no_telp_pelanggan'] ?>" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-4">
            ...
            if (isset($_POST["checkout"]))
            {
                ...
                $koneksi->query("INSERT INTO pembelian (
                    ...
                    VALUES ('$id_pelanggan', '$id_ongkir', '$tanggal_pembelian', '$total_pembelian', '$nama_kota',
                    '$tarif', '$alamat_pengiriman')");
                //mendapatkan id_pembelian barus saja terjadi
                ...
                //tampilan dialihkan ke halaman nota dari  pembelian baru saja terjadi
